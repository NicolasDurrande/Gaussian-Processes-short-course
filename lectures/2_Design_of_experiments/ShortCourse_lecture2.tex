...
\end{center}
Today's question is: If the input points can be chosen, how can we obtain the best model?
\end{frame}
...
Good practice:
\begin{itemize}
	\item Using regular grids or space filling designs
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
\qquad \Large \structure{\textbf{Any question?}}
\end{frame}
