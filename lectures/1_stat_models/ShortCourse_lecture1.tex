...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
The course will be over 4 days, with lectures every morning and lab sessions during the afternoon. \\ \vspace{5mm}
The agenda is as follow:
\vspace{0.2cm}
\begin{itemize}
	\item \textbf{Day 1:} Statistical models in engineering
	\item \textbf{Day 2:} Design of experiments
	\item \textbf{Day 3:} Gaussian Process regression
	\item \textbf{Day 4:} Optimization  with Gaussian Process Regression
\end{itemize}
\end{frame}
...
\vspace{4mm}
\begin{center}
	\textbf{What value of $(a_l,\ w_l,\ t_l,\ w_w)$ give the longest falling time?}
\end{center}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
We still have many thinks to discuss about such models:
\begin{itemize}
