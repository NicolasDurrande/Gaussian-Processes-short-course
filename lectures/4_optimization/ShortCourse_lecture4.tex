...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
Optimization is probably on of the most common problem in engineering. \\
\vspace{4mm}
One can distinguish:
\begin{itemize}
...
\end{itemize}
We usually consider as a reference the minimization problem instead of the maximization one.\\
\vspace{5mm}
In this lecture, we will consider that \textbf{inputs are continuous}.
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
The input space of the function to optimize can be continuous or discrete. In this lecture, we will focus on the first case. We will thus not detail methods such as 
\begin{itemize}
	\item Local optimization
	\item Global optimization
	\item Robust optimization
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
According to the context of the Short Course, we will focus on optimization methods that do not require a lot of function evaluations.\\
$\rightarrow$ model based optimization.\\
\vspace{5mm}
We will also pay a particular attention to optimization when
	\begin{itemize}
	 	\item Noisy observations
	 	\item Noise in parameter values
	 \end{itemize} 
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Evolutionary algorithms}
An famous Evolutionary algorithm for optimization is \textbf{CMA-ES}:\\
\vspace{3mm}
...
\vspace{5mm}
Some improvements have been made toward
\begin{itemize}
	\item Batch EGO
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[noframenumbering]{}
Usual optimization technics such as 
\begin{itemize}
